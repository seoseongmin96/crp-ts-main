...
return(<>
       ...
       <br/><br/><br/>
          ...
          <div style={{display: "flex", float:"left"}}>
            ...
            <img
              src="https://ifh.cc/g/v681j8.jpg"
              width="250"
              height="250"/><br/> <br/>
              <h5 className={styles.text}> 조 현 국 </h5>  <br/>
              <h4 className={styles.text}> NLP <br/> Transfomer, <br/> Bert, GPT-3 </h4> 
              <h6 className={styles.text}> Pytorch  </h6> <br/>
              <p className={styles.text}> VoiceBot,Lyrics Software Developer </p>
            ...
            <div className={styles.table}>
              <img
              src="https://ifh.cc/g/adgod5.jpg"
              width="250"
              height="250"/><br/> <br/>
              <h5 className={styles.text}> 최 은 아 </h5>  <br/>
              <h4 className={styles.text}> GAN</h4>
              <h6 className={styles.text}> Tensorflow </h6> <br/>
